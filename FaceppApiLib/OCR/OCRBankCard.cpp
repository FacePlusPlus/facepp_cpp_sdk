...
#include "OCRBankCard.hpp"
#include "CurlPost.hpp"
#include "curl.h"

void OCRBankCard::detectBankCard(const char *api_key, const char *api_secret, const char *filePath) {
    
    const char *URL = "https://api-cn.faceplusplus.com/cardpp/v1/ocrbankcard";
