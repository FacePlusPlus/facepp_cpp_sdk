...
#include "HumanBodySkeleton.hpp"
#include "CurlPost.hpp"
#include "curl.h"

void HumanBodySkeleton::detectSkeleton(const char *api_key, const char *api_secret, const char *filePath) {
    
    const char *URL = "https://api-cn.faceplusplus.com/humanbodypp/v1/skeleton";
