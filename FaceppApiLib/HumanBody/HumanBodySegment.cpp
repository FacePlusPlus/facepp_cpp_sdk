...
#include "HumanBodySegment.hpp"
#include "CurlPost.hpp"
#include "curl.h"

void HumanBodySegment::humanbodySegment(const char *api_key, const char *api_secret, const char *filePath) {
    
    const char *URL = "https://api-cn.faceplusplus.com/humanbodypp/v2/segment";
