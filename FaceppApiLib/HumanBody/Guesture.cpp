...
#include "Guesture.hpp"
#include "CurlPost.hpp"
#include "curl.h"

void Guesture::detectGuesture(const char *api_key, const char *api_secret, const char *filePath) {
    
    const char *URL = "https://api-cn.faceplusplus.com/humanbodypp/beta/gesture";
