...
#include "ImageLicenseplate.hpp"
#include "CurlPost.hpp"
#include "curl.h"

void LicensePlate::detectLicensePlate(const char *api_key, const char *api_secret, const char *filePath) {
    
    const char *URL = "https://api-cn.faceplusplus.com/imagepp/v1/licenseplate";
