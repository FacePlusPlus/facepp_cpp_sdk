...
#include "RecognizeText.hpp"
#include "CurlPost.hpp"
#include "curl.h"

void RecognizeTextApi::recognizetext(const char *api_key, const char *api_secret, const char *filePath) {
    
    const char *URL = "https://api-cn.faceplusplus.com/imagepp/v1/recognizetext";
