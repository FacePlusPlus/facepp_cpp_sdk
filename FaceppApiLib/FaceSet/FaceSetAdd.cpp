...
#include "FaceSetAdd.hpp"
#include "CurlPost.hpp"
#include "curl.h"

void FaceSetAddFaceApi::addFace(const char *api_key, const char *api_secret, const char *faceset_token, const char *face_tokens){
    
    const char *URL = "https://api-cn.faceplusplus.com/facepp/v3/faceset/addface";
