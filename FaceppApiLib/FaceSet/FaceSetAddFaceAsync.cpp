...
#include "FaceSetAddFaceAsync.hpp"
#include "CurlPost.hpp"
#include "curl.h"

void FaceSetAddFaceAsyncApi::addFaceAsync(const char *api_key, const char *api_secret, const char *faceset_token, const char *face_tokens) {
